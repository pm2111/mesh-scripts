...
mesh_cell_property= load('D:\ARVC meshing automatic\patients\patient09\regions_full_light_coarse.txt');
H_mesh = read_CHASTE('D:\ARVC meshing automatic\patients\patient09\chaste09\HEART');
patient_folder ='D:\ARVC meshing automatic\patients\patient09\';
...
%corresponding to the region number next to it
    fid = fopen(strcat(patient_folder,'regions_full_light','.txt'),'w');
