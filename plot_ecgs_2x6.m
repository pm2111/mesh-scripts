...
%         figure(1);
  ...
  colours={'b','g', 'k','r','r','m','k','y','c'};
    colours={'b',[0.54 0.82 0.99], [0.91 0.41 0.17],[0.32 0.41 0.17],'r','m',[0.55 0 0 ],'k','c', [0.55 0 0 ]};
   colours={ [0 0 0], [0 0 1], [0.54 0.82 0.99], [0.91 0.41 0.17]};
   handles =[];
    % Grid: Horizontal: large unit = 200 ms, small unit = 40 ms
    %       Vertical:   large unit = 0.5 mV, small unit = 0.1 mV
    x_large_div = 40;            % 100 ms
