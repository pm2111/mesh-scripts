...
mesh = read_VTK('D:\ARVC meshing automatic\patients\patient05\ARVC05_ecgi_mesh.vtk','binary');

mesh.xyz = mesh.xyz/10;

region_names = dir('D:\ARVC meshing automatic\patients\patient05\ecgi aha\');

filename = 'D:\ARVC meshing automatic\patients\patient05\ecgi aha\';
...
write_VTK(mesh, 'D:\ARVC meshing automatic\patients\patient05\ECGi_mesh_labelled.vtk','binary');
