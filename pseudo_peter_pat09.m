...
V6wcon=V6_real;
    ...
    precordial{1}=[V1wcon,V2wcon,V3wcon,V4wcon,V5wcon,V6wcon];
...
V6w=V6_real;
    ...
    precordial{2}=[V1w,V2w,V3w,V4w,V5w,V6w];
...
if Eikonal_strong==1
    ...
    load('D:\ARVC meshing automatic\patients\patient09\results\TestHeart09LGEStrong\ecg.mat');
    Is=I_real;
    IIs=II_real;
    IIIs=III_real;
    aVRs=aVR_real;
    ...
    precordial{4}=[V1ws,V2ws,V3ws,V4ws,V5ws,V6ws];
...
V6wint=V6_real;
    ...
    precordial{3}=[V1wint,V2wint,V3wint,V4wint,V5wint,V6wint];

    for i=1:4
 for j=1:6
        precordial_loop=precordial{i};
        [QRS(j,i)]=qrs_estimator(precordial_loop(:,j));
        [~,ratio(j,i),~,~,~,~,~,R_peaks(j,i)]=qrs_estimator(precordial_loop(:,j));
        [ ~,~,duration(j,i),swaves(j,i)]=s_wave_area(precordial_loop(:,j));
 end
end
%%
...
figure()
bar([vertcat(duration(1:4,1:4)',duration_ecgi(1:4))]')
...
figure()
bar([vertcat(QRS(1:6,1:4)',QRSs_ecgi(1:6))]')
ylabel('QRS duration [ms]','FontSize',30)
...
if lge2==1
    plot(ts(offset:size(Iint,1)),Iint,'g','LineWidth',3)
end
if lge_strong==1
    plot(ts(offset:size(Is,1)),Is,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(Is,1)),Iss,'Color','g','LineWidth',3)
end
...
if lge2==1
    plot(ts(offset:size(IIint,1)),IIint,'g','LineWidth',3)
end
if lge_strong==1

    plot(ts(offset:size(IIs,1)),IIs,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(Is,1)),IIss,'Color','g','LineWidth',3)
end
if data==1
...
if lge_strong==1
    ...
    plot(ts(offset:size(IIIs,1)),IIIs,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(IIIs,1)),IIIss,'Color','g','LineWidth',3)
end
if data==1
...
plot(ts(offset:size(aVRs,1)),aVRs,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(aVRss,1)),aVRss,'Color','g','LineWidth',3)
end
...
if lge2==1
    plot(ts(offset:size(aVLint,1)),aVLint,'g','LineWidth',3)
end
if lge_strong==1
plot(ts(offset:size(aVLs,1)),aVLs,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(aVLss,1)),aVLss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(aVFint,1)),aVFint,'g','LineWidth',3)
end
if lge_strong==1
...
if lge_very_strong==1
    plot(ts(offset:size(aVFss,1)),aVFss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(V1wint,1)),V1wint,'g','LineWidth',3)
end
if lge_strong==1
...
if lge_very_strong==1
    plot(ts(offset:size(V1wss,1)),V1wss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(V2wint,1)),V2wint,'g','LineWidth',3)
end
if lge_strong==1

plot(ts(offset:size(V2ws,1)),V2ws,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(V2wss,1)),V2wss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(V3wint,1)),V3wint,'g','LineWidth',3)
end
if lge_strong==1

plot(ts(offset:size(V3ws,1)),V3ws,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(V3wss,1)),V3wss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(V4wint,1)),V4wint,'g','LineWidth',3)
end
if lge_strong==1
...
if lge_very_strong==1
    plot(ts(offset:size(V4wss,1)),V4wss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(V5wint,1)),V5wint,'g','LineWidth',3)
end
if lge_strong==1
...
if lge_very_strong==1
    plot(ts(offset:size(V5wss,1)),V5wss,'Color','g','LineWidth',3)
end
if data==1
...
if lge2==1
    plot(ts(offset:size(V6wint,1)),V6wint,'g','LineWidth',3)
end
if lge_strong==1

plot(ts(offset:size(V6ws,1)),V6ws,'Color',[0.91 0.41 0.17],'LineWidth',3)
end
if lge_very_strong==1
    plot(ts(offset:size(V6wss,1)),V6wss,'Color','g','LineWidth',3)
end
if data==1
...
if lge==1 && lge2==1
    legend('sim no LGE','sim lge light', 'sim lge intermediate','sim lge light LV anterior + intermediate lge septal + eikonal','sim lge very strong','recorded ECG');
     ...
     legend('recorded mild ARVC phenotype ECG');
...
i=1;
subplot('Position',[(.12+mod(i-1,3))/3 1.125-(ceil(i/3))/3 1/4 1/5])
hold all
...
i=4;
subplot('Position',[(.12+mod(i-1,3))/3 1.195-(ceil(i/3))/3 1/4 1/5])
hold all
...
grid on
if lge==1 && lge2==1
    legend('sim no LGE','sim LGE CV scaling factor 0.58', 'sim LGE CV scaling factor 0.5 ','sim LGE CV scaling factor 0.4 ','sim LGE CV scaling factor 0.33 ');
else
     legend( 'recorded mild phenotype ECG');
