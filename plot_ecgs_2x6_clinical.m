function ECGs = plot_ecgs_2x6_clinical(signal,leg,individual_figures,col)
    ...
    for simu = 1
        ...
        for n=1:12
            ...
            if ischar(colours{simu})
                plot(ECGs{n},'color',colours{col},'LineWidth',3);
            else
                plot(ECGs{n},'LineWidth',3,'color',colours{col});
            end
                grid on
