...
%     axis off
    ...
    purk_slow=[0.4,0.6,0.8,1];
       for j=1:4
         ...
         %  ts_scaling_no_fib(1:11)= ts_scaling_no_fib(1:11)*1/LV_scal(i);
           ...
           no_lge(H_mesh.rv)=1/purk_slow(j);
           ...
           adv_lge(H_mesh.lv)=1;
            ...
            dlmwrite(strcat(patient_sim_folder,'scalings\eikonal06_coarse_fib_',num2str(0),'_RV_purk_',num2str(sprintf('%1.1f',purk_slow(j))),'.csv'), no_lge,'precision',10);
            %dlmwrite(strcat(patient_sim_folder,'scalings\eikonal06_coarse_fib_',num2str(1),'_LV_scaling_',num2str(sprintf('%1.1f',LV_scal(i))),'_RV_scaling_',num2str(sprintf('%1.1f',RV_scal(j))),'.csv'), light_lge,'precision',10);
            %dlmwrite(strcat(patient_sim_folder,'scalings\eikonal06_coarse_fib_',num2str(2),'_LV_scaling_',num2str(sprintf('%1.1f',LV_scal(i))),'_RV_scaling_',num2str(sprintf('%1.1f',RV_scal(j))),'.csv'),  int_lge,'precision',10);
            %dlmwrite(strcat(patient_sim_folder,'scalings\eikonal06_coarse_fib_',num2str(3),'_LV_scaling_',num2str(sprintf('%1.1f',LV_scal(i))),'_RV_scaling_',num2str(sprintf('%1.1f',RV_scal(j))),'.csv'),  adv_lge,'precision',10);
           %end
       end
 ...
 headlight
 hold on
 patch('vertices',H_mesh.xyz,'faces',H_mesh.face,'edgecolor','none','FaceVertexCData',int_lge,'facecolor','interp')
colorbar 
axis off
...
%    
    ...
    figure()
     ...
     set(gca,'Fontsize',25)
     xlabel('LGE Intensity [%]','Fontsize',25)
     ylabel('CV scaling factor ','Fontsize',25)
     legend({'low density fibrosis','intermediate density fibrosis','high density fibrosis'},'Fontsize',25)
%     camlight 
%     axis off
