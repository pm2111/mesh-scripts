...
roots09=dlmread('D:\ARVC meshing automatic\patients\patient06\eikonal06_coarse_rootNodes5_RV_anterior_5_RV_posterior_3.csv');

LV0_roots = roots09(1:4);
RV0_roots = roots09(5:end);
...
H1 = read_CHASTE( 'D:\ARVC meshing automatic\patients\patient06\chaste06\HEART'  );
...
u = loadv( strcat(SUBJECT_DIR, 'mpp\Hmapping6fineto6') , 'u' ); %transfer matrix u
...
dlmwrite(strcat(SUBJECT_DIR,'eikonal06_coarse_rootNodes09.csv'),[LV1_roots;RV1_roots]','delimiter',',','precision',10);
...
figure()
    patch('Faces',H_mesh2.face,'Vertices',H_mesh2.xyz,'EdgeColor','none');
headlight
hold on
    scatter3(H_mesh2.xyz(rootsNew,1),H_mesh2.xyz(rootsNew,2),H_mesh2.xyz(rootsNew,3),135,'filled','r')
colorbar
