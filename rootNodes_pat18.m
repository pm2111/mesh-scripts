...
enableVTK;
TORSO_MODEL_DIR = 'D:\ARVC meshing automatic\patients\patient18\chaste_gmsh\';
SUBJECT_DIR = 'D:\ARVC meshing automatic\patients\patient18\';
...
H1_full = read_CHASTE(  'D:\ARVC meshing automatic\patients\patient18\chaste_gmsh\HEART'); %our target heart
...
try 
    root_nodes =load(strcat(SUBJECT_DIR,'\root nodes\start.txt'));
    LV1_roots=[];
    RV1_roots =[];
