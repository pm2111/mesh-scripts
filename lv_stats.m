function [LV_summary]=lv_stats(mesh_location,aha_regions,patient_nr)
...
for i=1
    ...
    for j=1:nr_lv_regions
       ...
       region_minima_ind(j)=id;
       region_minima_value(j) = value;
       LV_summary{j,3} = value; %maxima of activation
    end
...
for i=1
    ...
    for j=1:nr_lv_regions
       ...
       LV_summary{j,4} = value;
       LV_summary{j,6} = mean(grad_region);
