...
addpath('/data/DropPeter/Dropbox/sim3d scripts');
addpath(genpath('/data/DropPeter/Dropbox/qrs/'));


[Ie,IIe,IIIe,aVRe,aVLe,aVFe,V1e,V2e,V3e,V4e,V5e,V6e,Ie_f,IIe_f,IIIe_f,aVRe_f,aVLe_f,aVFe_f,V1e_f,V2e_f,V3e_f,V4e_f,V5e_f,V6e_f,ts_ecgi]=ecgi_ECG06_linux('/data/Data_ARVC_raw_electrodes_vest/Data_ARVC/ARVC6/ARVC6_Baseline.mat','/data/ChrisReconstructions/ARVC6/ARVC6_Baseline.mat','/data/meshes/patient06/chaste06/ECG_ELECTRODES.mat',6);
ecg_ecgi=[V1e_f,V2e_f,V3e_f,V4e_f,V5e_f,V6e_f];
pop_path='/data/sim3d/Eikonal/exp14_ECGs/';
plt_acts=0;
keep_models={};
patient_nr='06';
sim_name='Eikonal';
