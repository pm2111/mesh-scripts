...
H1 = read_VTK('D:\ARVC meshing automatic\patients\patient06\chaste06\HEART.vtk');
H_mesh=read_CHASTE('D:\ARVC meshing automatic\patients\patient06\chaste06\HEART');
...
H0 = read_VTK(  'D:\ARVC meshing automatic\patients\patient06\HEART_0.70.vtk'); %our target heart
...
u = loadv( strcat(SUBJECT_DIR, 'mpp\Hmapping6coarse2fine') , 'u' ); %transfer matrix u
...
figure()
    patch('Faces',H_mesh.face,'Vertices',H_mesh.xyz,'EdgeColor','none');
hplot3d( H_mesh.xyz( LV1_roots(1) ,:) , 'o1kb20' );
hplot3d( H_mesh.xyz( LV1_roots(2) ,:) , 'o1kg20' );
hplot3d( H_mesh.xyz( LV1_roots(3) ,:) , 'o1km20' );
hplot3d( H_mesh.xyz( LV1_roots(4) ,:) , 'o1ky20' );
headlight
hplot3d( H_mesh.xyz( RV1_roots(1) ,:) , 'o1kr20' );
hplot3d( H_mesh.xyz( RV1_roots(2) ,:) , 'o1kb20' );
hplot3d( H_mesh.xyz( RV1_roots(3) ,:) , 'o1kg20' );
hplot3d( H_mesh.xyz( RV1_roots(4) ,:) , 'o1kg20' );
...
dlmwrite(strcat(SUBJECT_DIR,'eikonal06_coarse_rootNodes.csv'),[LV1_roots;RV1_roots]','delimiter',',','precision',10);
