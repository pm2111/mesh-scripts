...
lv_summary =   rv_stats(filename,regions_filename,2);
...
fillBullseye([lv_summary{10,2}],0.5,1,135,225); %lv apical free wall
fillBullseye([lv_summary{9,2}],0.5,1,-135,-45);%lv apical inferior

fillBullseye([lv_summary{7,2}],1,1.5,120,180); %lv mid anterolateral wall
fillBullseye([lv_summary{8,2}],1,1.5,60,120); %lv mid anterior
fillBullseye([lv_summary{5,2}],1,1.5,-180,-120); %lv mid inferior
fillBullseye([lv_summary{6,2}],1,1.5,-120,-60); %lv mid inferolateral wall 

fillBullseye([lv_summary{3,2}],1.5,2,120,180); %lv basal anterolateral wall
fillBullseye([lv_summary{4,2}],1.5,2,60,120); %lv basal anterior
fillBullseye([lv_summary{1,2}],1.5,2,-180,-120); %lv basal inferior
