...
load('D:\ARVC meshing automatic\patients\patient09\results\TestHeart09LGEIntermediate\ecg.mat');
Iint=I_real;
IIint=II_real;
IIIint=III_real;
aVRint=aVR_real;
...
grid on
if lge==1 && lge2==1
    legend('sim lge strong','sim lge light', 'sim lge intermediate','body surface potentials');
else
