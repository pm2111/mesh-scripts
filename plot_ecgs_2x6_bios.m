function ECGs = plot_ecgs_2x6_bios(signal,leg,individual_figures,col,ts,q_id,s_id,s_nadir_id)
...
%             else
                ...
                hold on
                dummy=ECGs{1,n};
                scatter(ts(q_id(n,1)),dummy(q_id(n)),35,'k','filled');
                scatter(ts(s_id(n,1)),dummy(s_id(n)),35,'b','filled');
                scatter(ts(s_nadir_id(n,1)),dummy(s_nadir_id(n)),35,'g','filled');
