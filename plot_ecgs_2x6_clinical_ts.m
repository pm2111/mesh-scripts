function ECGs = plot_ecgs_2x6_clinical(signal,leg,individual_figures,col,ts)
    ...
    for simu = 1
        ...
        for n=1:12
            ...
            if individual_figures
                ...
                y = ceil(n/13);  % 1 based!
                subplot('Position',[x/12 row_cum_sum(y) 1/12 row_height_rel(y)]);
            ...
            if ischar(colours{simu})
               ...
               % set(gca,'GridLineStyle','-','LineWidth',0.1);
                ...
                if(~individual_figures)
                    ...
                    text(40, row_max(y)-1, key_out(m,:), 'FontName', 'Times', 'FontUnits', 'normalized', 'FontSize', font_size);
                else
                    font_size = 0.1*4;
