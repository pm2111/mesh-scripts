...
data_path = 'D:\ARVC meshing automatic\patients\patient06\chaste06_edge_0.15_RV_0.2\';
mpp_path = 'D:\ARVC meshing automatic\patients\patient06\mpp\';
save_path = 'D:\ARVC meshing automatic\patients\patient06\chaste06_edge_0.15_RV_0.2\';

new_path = 'eikonal06_edge_0.15_RV_0.2';
...
fileName_final = 'eikonal06_edge_0.15_RV_0.2';
...
rvNodes = dlmread([data_path fileName '.rv'], ' ', 0, 0)+1;
lvNodes = dlmread([data_path fileName '.lv'], ' ', 0, 0)+1;
epiNodes = dlmread([data_path fileName '.epi'], ' ', 0, 0)+1;
fineFaces = dlmread([data_path fileName '.face'], ' ', 1, 1)+1;
...
%electrode positions
electrodes=load(strcat(mpp_path,'ECG_ELECTRODES.mat'));
...
pos=pos;
dlmwrite(strcat(save_path,   new_path, '/' ,fileName_final, '_electrodePositions.csv'),pos/10);
